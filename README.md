...
| `ecommerce/inventory-forecasting/inventory_forecasting.ipynb` | Monthly demand forecasting per category using Prophet. Rolling mean vs Prophet comparison. Reorder point recommendations with 95% confidence interval logic. No API key required. | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Nub-Labs/playbooks/blob/main/ecommerce/inventory-forecasting/inventory_forecasting.ipynb) |
